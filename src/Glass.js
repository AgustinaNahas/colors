...
export default function Glass(props) {
    ...
    const { percentage, color, setColor, ...others } = props;
    ...
    return (
        <div {...others}>
            ...
            {setColor ?
                <SketchPicker
                    color={ color }
                    onChangeComplete={ (hex) => setColor(hex.hex) }
                />
                :
                <div style={{ width: 20, height: 296 }}></div>
            ...
            <div className="box">
                ...
                <div id="water" className="water" style={{ transform: `translate(0, ${100 - percentage}%)`, background: color }} >

                    <svg viewBox="0 0 560 20" className="water_wave water_wave_front" fill={color}>
